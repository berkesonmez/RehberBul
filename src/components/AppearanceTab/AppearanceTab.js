...
class AppearanceTab extends Component {
                ...
                <List disablePadding>
                        ...
                        <ListItem>
                            ...
                            >
                                ...
                                <Hidden smUp>
                                    ...
                                    >
                                        {Object.keys(appearance.colors).map(
                                            (color) => {
                                                color =
                    ...
                    <ListItem>
                        ...
                        <ListItemText
                            ...
                            secondary="Genellikle karanlık olarak gösterilir"
                        />
                    ...
                    <ListItem>
                        ...
                        <ListItemText
                            primary="Temayı sıfırla"
                            secondary={
                                appearance.isDefaultTheme(theme)
                                    ? "Değişiklik yapılmadı"
                                    : "Değişiklikler sıfırlanacak"
                            }
                        />
    ...
    componentDidMount() {
        this.setState({
            ...
            secondaryColorLabelWidth: this.secondaryColorLabel.current
                .offsetWidth,
        });
    }
}
