                ...
                authentication
                    ...
                    .then(() => {
                        this.closeAllDialogs(() => {
                            this.openSnackbar("Hesap silindi");
                        });
                    })
                    .catch((reason) => {
        ...
        this.setState(
            ...
            () => {
                authentication
                    ...
                    .then(() => {
                        this.closeAllDialogs(() => {
                            this.openSnackbar("Çıkış yapıldı");
                        });
                    })
                    .catch((reason) => {
                        const code = reason.code;
                ...
                <ErrorBoundary>
                    ...
                    {ready && (
                        <>
                                ...
                                dialogs={{
                                    ...
                                    signOutDialog: {
                                        ...
                                        props: {
                                            title: "Çıkış yap?",
                                            contentText:
                                                "Çıkış yaptığınızda profilinizde değişiklik yapamazsınız ve giriş yapmanızı gerektiren aktiviteleri yapamazsınız.",
                                            dismissiveAction: (
                                                <Button
                                                    color="primary"
                                                    onClick={() =>
                            ...
                            />
                            {user ? <NewPostFAB user={user} /> : null}
                        </>
                    )}
                </ErrorBoundary>
            </MuiThemeProvider>
